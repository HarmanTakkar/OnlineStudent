...
public final class marks_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <tr style=\"background-color:bisque; color: buttonhighlight; font-weight: bold;\">\n");
      out.write("                <td>Student's Name</td>\n");
      out.write("                <td>Marks(in %age)</td>\n");
      out.write("            </tr>\n");
      out.write("        ");
		...
		conn=(Connection)DriverManager.getConnection(myUrl,"root","");
                ...
                String qry="select name,marks from admin where name= '"+name+"'";    
